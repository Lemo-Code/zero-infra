...
![1.2.2乌龟测试](assets/1.2.2%E4%B9%8C%E9%BE%9F%E6%B5%8B%E8%AF%95.gif)

**案例2：**自实现第一个ROS2小程序，在终端输出文本：hello world!。

![1.3.1helloworld](assets/1.3.1helloworld.PNG)

**案例3：**使用VSCode搭建ROS2集成开发环境，提高开发效率。

![1.4.1code使用演示](assets/1.4.1code%E4%BD%BF%E7%94%A8%E6%BC%94%E7%A4%BA.gif)
